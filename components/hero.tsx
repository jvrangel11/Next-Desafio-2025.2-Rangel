export default function Hero() {
  return (
    <section className="relative bg-[url('/assets/bg1.png')] bg-no-repeat bg-cover bg-center text-white">
      <div className="max-w-6xl mx-auto flex flex-col items-center justify-center py-10 sm:py-16 px-2 sm:px-4 text-center gap-6 lg:flex-row lg:px-0 lg:mx-0 lg:max-w-1000 lg:pr-20">
        <img
